<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"C:\wamp64\www\tp5-first\public/../application/admin\view\article\lst.htm";i:1508768605;s:74:"C:\wamp64\www\tp5-first\public/../application/admin\view\common\navbar.htm";i:1508826438;s:75:"C:\wamp64\www\tp5-first\public/../application/admin\view\common\sidebar.htm";i:1508673479;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                        ...
                        <tbody>
                            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td align="center">
                                        <?php if($vo['pic'] != ''): ?>
                                        <img src="__STATIC__/<?php echo $vo['pic']; ?>" height="50px">
                                        <?php else: ?>
                                        暂无缩略图
                                        <?php endif; ?>
                                    </td>
                                    <td align="center"><?php echo $vo['cate']['catename']; ?></td>
                                    <td align="center">
                                        <a href="<?php echo url('Article/editArticle',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
