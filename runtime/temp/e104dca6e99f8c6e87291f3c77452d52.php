<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"C:\wamp64\www\tp5-first\public/../application/admin\view\article\add.htm";i:1508764250;s:74:"C:\wamp64\www\tp5-first\public/../application/admin\view\common\navbar.htm";i:1508826438;s:75:"C:\wamp64\www\tp5-first\public/../application/admin\view\common\sidebar.htm";i:1508673479;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                    <textarea class="form-control" name="descc" id="descc" cols="10" rows="3"></textarea>                            </div>
                            </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <label for="state">
                                    <input type="checkbox" name="state" id="state" class="checkbox-slider colored-darkorange">
