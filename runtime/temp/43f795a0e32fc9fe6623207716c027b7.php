<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"C:\wamp64\www\mybsweb\public/../application/admin\view\links\lst.htm";i:1508645699;s:72:"C:\wamp64\www\mybsweb\public/../application/admin\view\common\navbar.htm";i:1508826438;s:73:"C:\wamp64\www\mybsweb\public/../application/admin\view\common\sidebar.htm";i:1508928277;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                        ...
                        <tbody>
                            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td align="center">
                                        <?php if($vo['descc'] != ''): ?>
                                            <?php echo $vo['descc']; else: ?>
                                        暂无描述
                                        <?php endif; ?>

                                    </td>
                                    <td align="center">
                                        <a href="<?php echo url('Links/editLinks',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
