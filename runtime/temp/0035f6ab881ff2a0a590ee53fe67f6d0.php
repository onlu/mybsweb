<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"C:\wamp64\www\mybsweb\public/../application/index\view\index\mypage.htm";i:1508935622;s:72:"C:\wamp64\www\mybsweb\public/../application/index\view\common\common.htm";i:1508922080;}*/ ?>
<!doctype html>
<html lang="zh-CN">
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			...
			<ul class="login fr">
				...
				<li style="margin-right:20px;color: #fff;">欢迎你,<a style="color: deeppink"><?php echo \think\Request::instance()->session('username'); ?></a>>!</li>
				<?php endif; ?>
	...
	<div class="left col-sm-8 col-xs-12" style="width: 830px;border:4px solid #ccc;border-radius: 20px;margin-top: 20px;">
		...
		<div class="right" style="margin-right: 10px;" >
			<div class="list-group col-sm-4 hidden-xs hh" style="width: 430px;margin-left: 40px;">
				...
				<a href="http://www.qinxue.com" class="list-group-item active" target="_blank">勤学网</a>
				<a href="http://www.w3school.com.cn/" class="list-group-item" target="_blank">W3Cschool</a>
				<a href="https://ke.qq.com/" class="list-group-item" target="_blank">腾讯课堂</a>
				<a href="https://chuanke.baidu.com/" class="list-group-item" target="_blank">百度传课</a>
				<a href="http://www.imooc.com/" class="list-group-item" target="_blank">慕课网</a>
				<a href="#" class="list-group-item" target="_blank">Linux</a>
