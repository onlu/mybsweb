<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"C:\wamp64\www\tp5-first\public/../application/admin\view\links\add.htm";i:1508644217;s:74:"C:\wamp64\www\tp5-first\public/../application/admin\view\common\navbar.htm";i:1508586856;s:75:"C:\wamp64\www\tp5-first\public/../application/admin\view\common\sidebar.htm";i:1508642523;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            <label for="descc" class="col-sm-2 control-label no-padding-right">链接说明</label>
                            <div class="col-sm-6">
                                <textarea class="form-control" name="descc" id="descc" cols="30" rows="10"></textarea>
                            </div>
